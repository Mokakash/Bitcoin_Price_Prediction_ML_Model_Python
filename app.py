...
#load Model 
model = load_model('/Users/mokakash/Documents/MAIN/DATA LEARN/Portfolio_Projects/Python_Projects/BTC_Price_Prediction/Bitcoin_Price_prediction_Model.keras')
